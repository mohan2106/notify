			...
			<div class="row">
				<div class="col-lg-6">
					...
					<form action="" method="post">
						...
						<div class="form-group" style="display: none" id="topic_group">
							<label for="topic">Choose Destination:</label>
				...
				<div class="col-lg-6">
					...
					if(isset($_POST['title'])){
						...
						$firebase_api = 'AAAApuSY3t0:APA91bEeY-GLxCEgfDhSh0r7hbfnmfaPnj2-YYBL48dXzRbtk6JQRGNT4jyUWJ3un-lqbo4bhFS9ybrWKlO3XqQSQBFg9QK_DK_WXYa6sun8esonZaQSGMHmzhR_u2XPx3RY4yPJpprS';
